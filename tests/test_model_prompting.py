...
class ModelPromptingTests(unittest.TestCase):
    def test_system_prompt_mentions_dummy_atoms_and_connected_subgraphs(self) -> None:
        system_prompt = build_counterfactual_system_prompt()

        self.assertIn("dummy atom '*'", system_prompt)
    ...
    def test_prompt_builder_includes_few_shot_examples(self) -> None:
        ...
        self.assertIn("FRAGMENT_SMILES: *O*", prompt)
    ...
    def test_clean_generated_smiles_prefers_capped_token(self) -> None:
