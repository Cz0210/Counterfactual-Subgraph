...
def _has_valid_past_key_values(past_key_values) -> bool:
    ...
    Newer generation paths may pass a non-None outer cache object whose first
    tuple entry is still None-like. InternLM2's original implementation assumes
    ``past_key_values[0][0]`` is always a tensor and crashes otherwise.
    """
