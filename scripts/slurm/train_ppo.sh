...
SUBSTRUCTURE_DISTANCE_MIN_ATOM_RATIO=${SUBSTRUCTURE_DISTANCE_MIN_ATOM_RATIO:-}
SUBSTRUCTURE_DISTANCE_MAX_ATOM_RATIO=${SUBSTRUCTURE_DISTANCE_MAX_ATOM_RATIO:-}
SUBSTRUCTURE_DISTANCE_TOPK=${SUBSTRUCTURE_DISTANCE_TOPK:-}
SUBSTRUCTURE_DISTANCE_MCS_TIMEOUT=${SUBSTRUCTURE_DISTANCE_MCS_TIMEOUT:-}
SUBSTRUCTURE_DISTANCE_SIM_THRESHOLD=${SUBSTRUCTURE_DISTANCE_SIM_THRESHOLD:-}
ENABLE_PROJECTED_CF_REWARD=${ENABLE_PROJECTED_CF_REWARD:-}
DISABLE_PROJECTED_CF_REWARD=${DISABLE_PROJECTED_CF_REWARD:-}
...
echo "ENABLE_SUBSTRUCTURE_DISTANCE_REWARD=${ENABLE_SUBSTRUCTURE_DISTANCE_REWARD:-<unset>}"
echo "SUBSTRUCTURE_DISTANCE_REWARD_WEIGHT=${SUBSTRUCTURE_DISTANCE_REWARD_WEIGHT:-<unset>}"
echo "SUBSTRUCTURE_DISTANCE_MIN_ATOM_RATIO=${SUBSTRUCTURE_DISTANCE_MIN_ATOM_RATIO:-<unset>}"
echo "SUBSTRUCTURE_DISTANCE_MAX_ATOM_RATIO=${SUBSTRUCTURE_DISTANCE_MAX_ATOM_RATIO:-<unset>}"
echo "SUBSTRUCTURE_DISTANCE_TOPK=${SUBSTRUCTURE_DISTANCE_TOPK:-<unset>}"
echo "SUBSTRUCTURE_DISTANCE_MCS_TIMEOUT=${SUBSTRUCTURE_DISTANCE_MCS_TIMEOUT:-<unset>}"
echo "SUBSTRUCTURE_DISTANCE_SIM_THRESHOLD=${SUBSTRUCTURE_DISTANCE_SIM_THRESHOLD:-<unset>}"
echo "ENABLE_PROJECTED_CF_REWARD=${ENABLE_PROJECTED_CF_REWARD:-<unset>}"
echo "DISABLE_PROJECTED_CF_REWARD=${DISABLE_PROJECTED_CF_REWARD:-<unset>}"
...
if [ -n "${SUBSTRUCTURE_DISTANCE_REWARD_WEIGHT}" ]; then
  cmd+=(--substructure-distance-reward-weight "${SUBSTRUCTURE_DISTANCE_REWARD_WEIGHT}")
fi
if [ -n "${SUBSTRUCTURE_DISTANCE_MIN_ATOM_RATIO}" ]; then
  cmd+=(--substructure-distance-min-atom-ratio "${SUBSTRUCTURE_DISTANCE_MIN_ATOM_RATIO}")
fi
if [ -n "${SUBSTRUCTURE_DISTANCE_MAX_ATOM_RATIO}" ]; then
  cmd+=(--substructure-distance-max-atom-ratio "${SUBSTRUCTURE_DISTANCE_MAX_ATOM_RATIO}")
fi
if [ -n "${SUBSTRUCTURE_DISTANCE_TOPK}" ]; then
  cmd+=(--substructure-distance-topk "${SUBSTRUCTURE_DISTANCE_TOPK}")
fi
if [ -n "${SUBSTRUCTURE_DISTANCE_MCS_TIMEOUT}" ]; then
  cmd+=(--substructure-distance-mcs-timeout "${SUBSTRUCTURE_DISTANCE_MCS_TIMEOUT}")
fi
if [ -n "${SUBSTRUCTURE_DISTANCE_SIM_THRESHOLD}" ]; then
  cmd+=(--substructure-distance-sim-threshold "${SUBSTRUCTURE_DISTANCE_SIM_THRESHOLD}")
fi
append_bool_flag "${ENABLE_PROJECTED_CF_REWARD}" "--enable-projected-cf-reward" "" "ENABLE_PROJECTED_CF_REWARD"
append_bool_flag "${DISABLE_PROJECTED_CF_REWARD}" "--disable-projected-cf-reward" "" "DISABLE_PROJECTED_CF_REWARD"
