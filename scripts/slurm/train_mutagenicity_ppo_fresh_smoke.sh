#!/bin/bash
# Fresh-SFT initialized, flip-dominant Mutagenicity PPO smoke.
...
#SBATCH --job-name=mut_fresh_ppo_smoke
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_ROOT/outputs/hpc/mutagenicity/ppo_fresh_v2_smoke}"
mkdir -p "$PROJECT_ROOT/logs"

echo "===== MUTAGENICITY FRESH PPO SMOKE ====="
...
echo "TEACHER_PATH=$TEACHER_PATH REWARD_CONFIG_JSON=$REWARD_CONFIG_JSON"
echo "OUTPUT_ROOT=$OUTPUT_ROOT MAX_PARENTS=5 samples_per_update=1 updates_per_epoch=5 MAX_UPDATES=5"
