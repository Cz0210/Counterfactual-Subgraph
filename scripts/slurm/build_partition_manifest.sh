#!/usr/bin/env bash
# CPU-only override: partition planning performs no neural inference.
#SBATCH --job-name=t8-partition-plan
...
python scripts/hpc/t8/build_partition_manifest.py --config configs/hpc.yaml "$@"
