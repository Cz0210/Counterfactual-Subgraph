#!/bin/bash
# 20-step decoded-chem PPO smoke test in core_output_mode.
...
#SBATCH --job-name=ppo_v3_core_smoke
...
python scripts/train_rl.py \
  ...
  --output-dir outputs/ppo_v3_core_smoke \
  --candidate-pool-path outputs/ppo_v3_core_smoke/candidate_pool.jsonl \
