#!/bin/bash
# 50-step decoded-chem PPO diagnostic run for parse-fix / connect-fix v4.
#
# Usage on HPC:
#   sbatch scripts/slurm/train_decoded_chem_ppo_parsefix_connectfix_diag50_v4.sh
...
#SBATCH --job-name=ppo_parsefix_v4
...
export RUN_NAME=decoded_chem_diag50_parsefix_connectfix_v4
...
export MIN_FRAGMENT_ATOMS=3
export TINY_FRAGMENT_HARD_FAIL_PENALTY=-6.0

export ENABLE_SIZE_WINDOW_REWARD=true
export SIZE_WINDOW_LOW=0.15
export SIZE_WINDOW_HIGH=0.65
export SIZE_WINDOW_BONUS=0.4
export SIZE_WINDOW_SMALL_PENALTY=-0.4
export SIZE_WINDOW_LARGE_PENALTY=-0.4
...
echo "MIN_FRAGMENT_ATOMS=${MIN_FRAGMENT_ATOMS}"
echo "TINY_FRAGMENT_HARD_FAIL_PENALTY=${TINY_FRAGMENT_HARD_FAIL_PENALTY}"
echo "ENABLE_SIZE_WINDOW_REWARD=${ENABLE_SIZE_WINDOW_REWARD}"
echo "SIZE_WINDOW_LOW=${SIZE_WINDOW_LOW}"
echo "SIZE_WINDOW_HIGH=${SIZE_WINDOW_HIGH}"
echo "SIZE_WINDOW_BONUS=${SIZE_WINDOW_BONUS}"
echo "SIZE_WINDOW_SMALL_PENALTY=${SIZE_WINDOW_SMALL_PENALTY}"
echo "SIZE_WINDOW_LARGE_PENALTY=${SIZE_WINDOW_LARGE_PENALTY}"
echo "====================="
...
echo "===== RUNNING DECODED CHEM PPO PARSEFIX CONNECTFIX DIAG50 V4 ====="
