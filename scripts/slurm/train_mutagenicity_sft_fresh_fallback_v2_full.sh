#!/bin/bash
# Fresh-LoRA SFT ablation using strict-first positive-CFDrop fallback targets.
...
#SBATCH --job-name=mut_fresh_fallback
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_ROOT/outputs/hpc/mutagenicity/sft_fresh_fallback_v2}"
mkdir -p "$PROJECT_ROOT/logs"
echo "===== MUTAGENICITY FRESH FALLBACK-V2 SFT FULL ====="
