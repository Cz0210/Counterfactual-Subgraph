#!/bin/bash
# Fresh-LoRA Mutagenicity strict-v2 SFT smoke from the pure ChemLLM base.
...
#SBATCH --job-name=mut_fresh_strict_v2_smoke
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_ROOT/outputs/hpc/mutagenicity/sft_fresh_strict_v2_smoke}"
mkdir -p "$PROJECT_ROOT/logs"

echo "===== MUTAGENICITY FRESH STRICT-V2 SFT SMOKE ====="
echo "PROJECT_ROOT=$PROJECT_ROOT"
echo "DATA_ROOT=$DATA_ROOT"
echo "DATASET_VARIANT=strict_v2"
...
echo "[MUTAGENICITY_FRESH_SFT_STRICT_V2_SMOKE_OK]"
