...
POOL=${PROJECT_ROOT}/outputs/hpc/full_candidate_pools/label1/sft_only_ckpt500_n4_temp07_top09/candidate_pool_label1_sft_only_ckpt500_n4.jsonl
...
OUT_DIR=${PROJECT_ROOT}/outputs/hpc/full_candidate_pools/label1/sft_only_ckpt500_n4_temp07_top09/audit
