#!/bin/bash
# Fresh-SFT initialized, flip-dominant Mutagenicity PPO medium audit run.
...
#SBATCH --job-name=mut_fresh_ppo_med
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_ROOT/outputs/hpc/mutagenicity/ppo_fresh_v2_medium}"
mkdir -p "$PROJECT_ROOT/logs"

echo "===== MUTAGENICITY FRESH PPO MEDIUM ====="
...
echo "MAX_PARENTS=256 samples_per_update=16 updates_per_epoch=16 MAX_UPDATES=16"
