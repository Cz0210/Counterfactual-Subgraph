#!/usr/bin/env bash
# CPU-only override: result packaging performs no neural inference.
#SBATCH --job-name=t8-result-bundle
...
python scripts/hpc/t8/build_result_bundle.py --config configs/hpc.yaml "$@"
