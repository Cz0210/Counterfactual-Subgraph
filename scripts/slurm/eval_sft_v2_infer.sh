...
#SBATCH --job-name=eval_sft_v2_infer
...
EVAL_FILE=${EVAL_FILE:-${PROJECT_DIR}/data/sft_val_v2.jsonl}
RUN_NAME=${RUN_NAME:-eval_sft_v2_$(date +%Y%m%d_%H%M%S)}
