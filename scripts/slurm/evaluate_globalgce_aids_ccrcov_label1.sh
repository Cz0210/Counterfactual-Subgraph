...
OUTPUT_DIR=${OUTPUT_DIR:-outputs/hpc/eval/globalgce/aids_official_top30/label1}
LABEL=${LABEL:-1}
K=${K:-30}
...
echo "===== GLOBALGCE AIDS CCRCov LABEL1 ENV CHECK ====="
...
echo "===== GLOBALGCE AIDS CCRCov LABEL1 DONE ====="
