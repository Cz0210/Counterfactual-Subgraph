...
# Run the bounded search from cheapest to most expensive while preserving the
...
SCRATCH_CASE_ROOT=${SCRATCH_CASE_ROOT:-$PERSISTENT_SCRATCH_ROOT/globalgce_bace_v6/min_freq_$MIN_FREQ}
POOL_DIR=$SCRATCH_CASE_ROOT/pool
SELECTOR_DIR=$CASE_ROOT/selector
MATRIX_POOL=$CASE_ROOT/matrix_pool.jsonl
MATRIX_DIR=$SCRATCH_CASE_ROOT/calibration_matrix
...
WNODE_CACHE_DB=${WNODE_CACHE_DB:-$SCRATCH_CASE_ROOT/wnode_cache.sqlite3}
