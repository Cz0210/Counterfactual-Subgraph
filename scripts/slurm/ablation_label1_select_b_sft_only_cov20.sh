...
POOL=${ROOT}/sft_only_n4/candidate_pool.jsonl
OUT_DIR=${ROOT}/selectors/sft_only_n4_cov20
...
if [ ! -f "${POOL}" ]; then
  ...
  echo "Please run: sbatch scripts/slurm/ablation_label1_generate_b_sft_only_n4.sh"
  exit 1
fi
