#!/bin/bash
# Fresh-LoRA SFT using the preserved current-v1 Mutagenicity targets.
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_ROOT/outputs/hpc/mutagenicity/sft_fresh_v1}"
mkdir -p "$PROJECT_ROOT/logs"
echo "===== MUTAGENICITY FRESH SFT V1 FULL ====="
...
python scripts/train_mutagenicity_sft_fresh.py \
  ...
  --expected-train-rows 1317 \
  --expected-val-rows 250
