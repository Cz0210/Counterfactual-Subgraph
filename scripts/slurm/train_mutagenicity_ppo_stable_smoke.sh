...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_ROOT/outputs/hpc/mutagenicity/ppo_stable_v1_smoke}"
SOURCE_LABEL="${SOURCE_LABEL:-1}"
TARGET_LABEL="${TARGET_LABEL:-0}"
MAX_PARENTS="${MAX_PARENTS:-5}"
ROLLOUT_BATCH_SIZE="${ROLLOUT_BATCH_SIZE:-1}"
SAMPLES_PER_UPDATE="$ROLLOUT_BATCH_SIZE"
MAX_UPDATES="${MAX_UPDATES:-5}"
...
echo "===== MUTAGENICITY STABLE PPO SMOKE ====="
