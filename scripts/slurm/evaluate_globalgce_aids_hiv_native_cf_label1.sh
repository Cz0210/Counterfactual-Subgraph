#!/bin/bash
#SBATCH -J globalgce_aids_hiv_cf_l1
...
OUT_DIR=${OUT_DIR:-outputs/hpc/eval/globalgce/aids_hiv_native_cf_fullgraph/label1}
...
echo "===== GLOBALGCE AIDS/HIV NATIVE-CF LABEL1 ENV CHECK ====="
...
echo "FLIP_DEFINITION=pred_before == target_label and pred_after != target_label"
...
echo "===== GLOBALGCE AIDS/HIV NATIVE-CF LABEL1 DONE ====="
