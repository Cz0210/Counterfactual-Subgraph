#!/bin/bash
# 50-step decoded-chem PPO diagnostic run for parse-fix / connect-fix v3.
#
# Usage on HPC:
#   sbatch scripts/slurm/train_decoded_chem_ppo_parsefix_connectfix_diag50_v3.sh
...
#SBATCH --job-name=ppo_parsefix_v3
...
export RUN_NAME=decoded_chem_diag50_parsefix_connectfix_v3
...
echo "===== RUNNING DECODED CHEM PPO PARSEFIX CONNECTFIX DIAG50 V3 ====="
