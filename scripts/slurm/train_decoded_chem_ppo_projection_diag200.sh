#!/bin/bash
# 200-step decoded-chem PPO diagnostic run with parent projection enabled.
#
# Usage on HPC:
#   cd /share/home/u20526/czx/counterfactual-subgraph
#   sbatch scripts/slurm/train_decoded_chem_ppo_projection_diag200.sh
...
#SBATCH --job-name=ppo_proj_diag200
...
RUN_NAME=decoded_chem_diag200_projection_v1
MAX_STEPS=200
LOGGING_STEPS=5
...
echo "===== RUNNING DECODED CHEM PPO PROJECTION DIAG200 ====="
