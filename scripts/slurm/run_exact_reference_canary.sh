#!/usr/bin/env bash
# CPU-only override: exact reference gSpan performs no neural inference.
#SBATCH --job-name=t8-exact-ref
...
python scripts/hpc/t8/run_exact_reference_canary.py --config configs/hpc.yaml "$@"
