#!/bin/bash
# Smoke-test Mutagenicity continued SFT from the stable AIDS SFT-v3 adapter.
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_ROOT/outputs/hpc/mutagenicity/sft_continued_v1_smoke}"
...
MAX_TRAIN_ROWS="${MAX_TRAIN_ROWS:-64}"
MAX_VAL_ROWS="${MAX_VAL_ROWS:-32}"
...
echo "===== MUTAGENICITY CONTINUED SFT SMOKE ====="
...
echo "MAX_VAL_ROWS=$MAX_VAL_ROWS"
...
echo "[MUTAGENICITY_CONTINUED_SFT_SMOKE_OK]"
