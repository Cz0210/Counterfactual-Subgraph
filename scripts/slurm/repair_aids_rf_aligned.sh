...
if [ "${AIDS_ACTION:-screen-pool}" = "recourse" ] || [ "${AIDS_ACTION:-screen-pool}" = "repair-gaps" ] || [ "${AIDS_ACTION:-screen-pool}" = "freeze-summary" ] || [ "${AIDS_ACTION:-screen-pool}" = "evaluate" ] || [ "${AIDS_ACTION:-screen-pool}" = "release" ]; then
