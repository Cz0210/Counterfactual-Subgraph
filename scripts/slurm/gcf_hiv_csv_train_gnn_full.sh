...
OUT_DIR=${OUT_DIR:-outputs/hpc/gcfexplainer_hiv_csv/gnn}
GNN_EPOCHS=${GNN_EPOCHS:-1000}

echo "===== GCF HIV CSV TRAIN GNN FULL ====="
...
echo "===== GCF HIV CSV TRAIN GNN FULL DONE ====="
