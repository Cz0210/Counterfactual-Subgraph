...
export CANDIDATE_PATH=${CANDIDATE_PATH:-$SHARED_PROJECT_ROOT/outputs/hpc/bace/baselines/gcfexplainer/full_v1/export/selected_top20.csv}
...
export WORK_ROOT=${WORK_ROOT:-$SHARED_PROJECT_ROOT/outputs/hpc/eval/bace_gcfexplainer_wnode_work_v1}
