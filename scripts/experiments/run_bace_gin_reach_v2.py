...
def main():
    ...
    p.add_argument("--action", required=True, choices=("plan", "evaluate", "ceiling", "train_gate", "audit_calibration", "freeze", "aggregate", "audit", "export", "status"))
    p.add_argument("--group", choices=("old66", "adopted2607", "aligned_pool"), default="old66")
